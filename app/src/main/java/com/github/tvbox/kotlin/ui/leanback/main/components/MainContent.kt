package com.github.tvbox.kotlin.ui.leanback.main.components
...
import com.github.tvbox.kotlin.ui.leanback.classicpanel.LeanbackClassicPanelScreen
import com.github.tvbox.kotlin.ui.leanback.components.LeanbackVisible
import com.github.tvbox.kotlin.ui.leanback.monitor.LeanbackMonitorScreen
import com.github.tvbox.kotlin.ui.leanback.panel.LeanbackPanelChannelNoSelectScreen
import com.github.tvbox.kotlin.ui.leanback.panel.LeanbackPanelDateTimeScreen
import com.github.tvbox.kotlin.ui.leanback.panel.LeanbackPanelScreen
...
import com.github.tvbox.kotlin.ui.leanback.video.rememberLeanbackVideoPlayerState
                ...
                LeanbackPanelScreen(
                    ...
                    onIptvFavoriteToggle = {
                        ...
                        if (settingsViewModel.iptvChannelFavoriteList.contains(it.channelName)) {
                            ...
                            LeanbackToastState.Companion.I.showToast("取消收藏: ${it.channelName}")
                        } else {
                            settingsViewModel.iptvChannelFavoriteList += it.channelName
                            LeanbackToastState.Companion.I.showToast("已收藏: ${it.channelName}")
                        }
                    },
