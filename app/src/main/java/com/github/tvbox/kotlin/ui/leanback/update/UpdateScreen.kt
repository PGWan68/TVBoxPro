...
import com.github.tvbox.kotlin.ui.leanback.update.components.LeanbackUpdateDialog
...
fun LeanbackUpdateScreen(
    ...
    LaunchedEffect(Unit) {
        delay(3000)
        updateViewModel.checkUpdate(packageInfo.versionName.toString())
        ...
        if (
            ...
            if (settingsViewModel.updateForceRemind) {
                ...
                LeanbackToastState.Companion.I.showToast("新版本: v${latestRelease.version}")
            }
        }
    }
        ...
        rememberLauncherForActivityResult(ActivityResultContracts.StartActivityForResult()) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                if (context.packageManager.canRequestPackageInstalls()) {
                    ...
                    LeanbackToastState.Companion.I.showToast("未授予安装权限")
                }
            }
        }
